...
describe("Pool using Aave V3 strategy", () => {
  if (
  ...
  describe("should behave like GG Pool", async () => {
    await shouldBehaveLikeGGPool("aaveV3");
  });

  describe("when an user tries to join a game", async () => {
    await shouldBehaveLikeJoiningGGPool("aaveV3");
  ...
  describe("when a player tries to rejoin", async () => {
    await shouldBehaveLikeReJoiningGGPool("aaveV3");
  ...
  describe("when an user tries to make a deposit", async () => {
    await shouldBehaveLikeDepositingGGPool("aaveV3");
  ...
  describe("when a user withdraws before the end of the game", async () => {
    await shouldBehaveLikeEarlyWithdrawingGGPool("aaveV3");
