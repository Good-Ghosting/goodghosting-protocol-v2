...
//     const getSlippageAmount = async (netAmount: any) => {
//       const userSlippage = 1;
//       let minAmount;
...
//       minAmount = await pool.methods
//         .calc_withdraw_one_coin(netAmount.toString(), providersConfigs.tokenIndex)
//         .call();

//       const userProvidedMinAmount = web3.utils
//         .toBN(netAmount)
//         .sub(web3.utils.toBN(netAmount).mul(web3.utils.toBN(userSlippage)).div(web3.utils.toBN(100)));
...
//         const minAmount = await getSlippageAmount(netAmountPaid)

//         let result;
//         // redeem already called hence passing in 0
//         console.log(i)
//         result = await goodGhosting.withdraw(minAmount.toString(), { from: player });
...
//         console.log(playerInfo.amountPaid.toString())
