...
contract("Pool with Curve Strategy with extra reward tokens sent to strategy", accounts => {
  ...
  describe("simulates a full game with 5 players and 4 of them winning the game and with admin fee % as 0", async () => {
    ...
    it("players withdraw from contract", async () => {
      // await goodGhosting.setreward();
      // const rewardtok = await goodGhosting.rewardTokenAmounts(0)
      // console.log("AMT", rewardtok.toString())
    ...
    it("admin withdraws admin fee from contract", async () => {
      if (adminFee > 0) {
        ...
        console.log("BALL", inboundcrvTokenPoolBalance.toString());
