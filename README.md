...
```
So let's take in a example, let's say there are 2 players in the game with only 1 segment and it's a flexible deposit pool, player1 deposits 10 DAI & player 2 deposits 100 DAI, but player 1 deposits early than player 2.
