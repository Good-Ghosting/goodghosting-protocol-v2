...
exports.deployConfigs = {
  strategy: "polygon-curve-stmatic-matic",
  inboundCurrencySymbol: "wmatic", // name of the inbound currency symbol. Must be defined in the object {providers.network} above.
  ...
  isWhitelisted: false,
  incentiveToken: "0x1c954e8fe737f99f68fa1ccda3e51ebdb291948c", // for fork tests, polygon incentive token 0x430EF9263E76DAE63c84292C3409D61c598E9682, 0x1c954e8fe737f99f68fa1ccda3e51ebdb291948c(matic) & celo incentive token 0x46c9757c5497c5b1f2eb73ae79b6b67d119b0b58, st celo(0x84c4e1f2965235f60073e3029788888252c4557e)
  initialize: true,
  rewardTokens: [
